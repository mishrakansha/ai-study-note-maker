                    ...
                    {showScore && (
                        ...
                        >
                            <div className="score-content">
                                <span className="score-icon">{percentage >= 70 ? "🎉" : percentage >= 50 ? "👍" : "📚"}</span>
                                            ...
                                            {q.options.map((opt, i) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        {showCorrectAnswer && <span className="check-icon">✓</span>}
                                                        {showWrongAnswer && <span className="cross-icon">✗</span>}
                                                    </button>
                                                )
                                            })}
                                        </div>
